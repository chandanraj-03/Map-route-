"""Helper script to create the EDA notebook."""
import json
import os
  ...
  "cells": [
    {
      ...
      "source": ["# AI Route Optimization - Exploratory Data Analysis\n",
    ...
    {
      "cell_type": "markdown", "metadata": {},
      "source": ["## 2. Traffic Distribution and Impact on Travel Time"]
    },
    {
      "cell_type": "code", "execution_count": None, "metadata": {}, "outputs": [],
      "source": [
    ...
    {
      "cell_type": "markdown", "metadata": {},
      "source": ["## 3. Driver Performance Analysis (Driver Features)"]
    },
    {
      "cell_type": "code", "execution_count": None, "metadata": {}, "outputs": [],
      "source": [
    ...
    {
      "cell_type": "markdown", "metadata": {},
      "source": ["## 4. Time Features - Delivery Patterns by Day of Week"]
    },
    {
      "cell_type": "code", "execution_count": None, "metadata": {}, "outputs": [],
      "source": [
    ...
    {
      "cell_type": "markdown", "metadata": {},
      "source": ["## 5. Route Features - Distance vs Travel Time"]
    },
    {
      "cell_type": "code", "execution_count": None, "metadata": {}, "outputs": [],
      "source": [
    ...
    {
      "cell_type": "markdown", "metadata": {},
      "source": ["## 6. Feature Correlation Matrix (ML Feature Engineering)"]
    },
    {
      "cell_type": "code", "execution_count": None, "metadata": {}, "outputs": [],
      "source": [
    ...
    {
      "cell_type": "markdown", "metadata": {},
      "source": ["## 7. Location Features - Regional Analysis and Store Density"]
    },
    {
      "cell_type": "code", "execution_count": None, "metadata": {}, "outputs": [],
      "source": [
    ...
    {
      "cell_type": "markdown", "metadata": {},
      "source": ["## 8. Model Target Distribution - Travel Time and Efficiency Score"]
    },
    {
      "cell_type": "code", "execution_count": None, "metadata": {}, "outputs": [],
      "source": [
